...
//)
//
//func CheckAuthToken(ctx context.Context, value string) (*models.AuthToken, error) {
//	if len(value) == 0 {
//		return nil, nil
//	}
//
...
//	}
//
//	t, err := models.GetAuthTokenByID(ctx, parts[0])
//	if err != nil {
...
//}
//
//func RegenerateAuthToken(ctx context.Context, t *auth_model.AuthToken) (*models.AccessToken, string, error) {
...
//		TokenHash:   hash,
//		UserID:      t.UserID,
//		ExpiresUnix: timeutil.TimeStampNow().AddDuration(time.Duration(configs.LogInRememberDays*24) * time.Hour),
//	}
//
