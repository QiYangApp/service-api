...
func (uasc *UserAuthSourceCreate) SetCreateTime(ts timeutil.TimeStamp) *UserAuthSourceCreate {
	uasc.mutation.SetCreateTime(ts)
	return uasc
}

// SetNillableCreateTime sets the "create_time" field if the given value is not nil.
func (uasc *UserAuthSourceCreate) SetNillableCreateTime(ts *timeutil.TimeStamp) *UserAuthSourceCreate {
	if ts != nil {
		uasc.SetCreateTime(*ts)
	}
	return uasc
}

// SetUpdateTime sets the "update_time" field.
func (uasc *UserAuthSourceCreate) SetUpdateTime(ts timeutil.TimeStamp) *UserAuthSourceCreate {
	uasc.mutation.SetUpdateTime(ts)
	return uasc
}
...
func (uasc *UserAuthSourceCreate) createSpec() (*UserAuthSource, *sqlgraph.CreateSpec) {
	...
	if value, ok := uasc.mutation.CreateTime(); ok {
		_spec.SetField(userauthsource.FieldCreateTime, field.TypeInt64, value)
