...
func (wdu *WakatimeDependencyUpdate) SetWakatimeID(i int64) *WakatimeDependencyUpdate {
	wdu.mutation.ResetWakatimeID()
	wdu.mutation.SetWakatimeID(i)
	return wdu
}

// SetNillableWakatimeID sets the "wakatime_id" field if the given value is not nil.
func (wdu *WakatimeDependencyUpdate) SetNillableWakatimeID(i *int64) *WakatimeDependencyUpdate {
	if i != nil {
		wdu.SetWakatimeID(*i)
	}
	return wdu
...
func (wdu *WakatimeDependencyUpdate) AddWakatimeID(i int64) *WakatimeDependencyUpdate {
	wdu.mutation.AddWakatimeID(i)
	return wdu
}
...
func (wdu *WakatimeDependencyUpdate) SetUpdateTime(ts timeutil.TimeStamp) *WakatimeDependencyUpdate {
	wdu.mutation.ResetUpdateTime()
	wdu.mutation.SetUpdateTime(ts)
	return wdu
}

// AddUpdateTime adds ts to the "update_time" field.
func (wdu *WakatimeDependencyUpdate) AddUpdateTime(ts timeutil.TimeStamp) *WakatimeDependencyUpdate {
	wdu.mutation.AddUpdateTime(ts)
	return wdu
}
...
func (wdu *WakatimeDependencyUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := wdu.mutation.AddedWakatimeID(); ok {
		_spec.AddField(wakatimedependency.FieldWakatimeID, field.TypeInt64, value)
	}
	...
	if value, ok := wdu.mutation.AddedUpdateTime(); ok {
		_spec.AddField(wakatimedependency.FieldUpdateTime, field.TypeInt64, value)
	}
...
// SetWakatimeID sets the "wakatime_id" field.
func (wduo *WakatimeDependencyUpdateOne) SetWakatimeID(i int64) *WakatimeDependencyUpdateOne {
	wduo.mutation.ResetWakatimeID()
	wduo.mutation.SetWakatimeID(i)
	return wduo
}

// SetNillableWakatimeID sets the "wakatime_id" field if the given value is not nil.
func (wduo *WakatimeDependencyUpdateOne) SetNillableWakatimeID(i *int64) *WakatimeDependencyUpdateOne {
	if i != nil {
		wduo.SetWakatimeID(*i)
	}
	return wduo
}

// AddWakatimeID adds i to the "wakatime_id" field.
func (wduo *WakatimeDependencyUpdateOne) AddWakatimeID(i int64) *WakatimeDependencyUpdateOne {
	wduo.mutation.AddWakatimeID(i)
	return wduo
}
...
// SetUpdateTime sets the "update_time" field.
func (wduo *WakatimeDependencyUpdateOne) SetUpdateTime(ts timeutil.TimeStamp) *WakatimeDependencyUpdateOne {
	wduo.mutation.ResetUpdateTime()
	wduo.mutation.SetUpdateTime(ts)
	return wduo
}

// AddUpdateTime adds ts to the "update_time" field.
func (wduo *WakatimeDependencyUpdateOne) AddUpdateTime(ts timeutil.TimeStamp) *WakatimeDependencyUpdateOne {
	wduo.mutation.AddUpdateTime(ts)
	return wduo
}
...
func (wduo *WakatimeDependencyUpdateOne) sqlSave(ctx context.Context) (_node *WakatimeDependency, err error) {
	...
	if value, ok := wduo.mutation.AddedWakatimeID(); ok {
		_spec.AddField(wakatimedependency.FieldWakatimeID, field.TypeInt64, value)
	}
	...
	if value, ok := wduo.mutation.AddedUpdateTime(); ok {
		_spec.AddField(wakatimedependency.FieldUpdateTime, field.TypeInt64, value)
	}
