...
func (mrrp *MemberRoleRelatedPermissionQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := mrrp.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (pg *PermissionGroupQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := pg.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (prr *PermissionRelatedRouterQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := prr.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (uas *UserAuthSourceQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := uas.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (urr *UserRelatedRoleQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := urr.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (ur *UserRoleQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := ur.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (wc *WakatimeCategoryQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := wc.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (wd *WakatimeDependencyQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := wd.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (we *WakatimeEditorQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := we.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (wgt *WakatimeGrandTotalQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := wgt.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (whb *WakatimeHeartBeatQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := whb.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (wp *WakatimeProjectQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := wp.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (wpd *WakatimeProjectDurationQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := wpd.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (wpi *WakatimeProjectInfoQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := wpi.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (ws *WakatimeSystemQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := ws.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
...
func (wac *WebAuthnCredentialQuery) Paginate(
	...
	if field := collectedField(ctx, edgesField, nodeField); field != nil {
		if err := wac.collectField(ctx, limit == 1, graphql.GetOperationContext(ctx), *field, []string{edgesField, nodeField}); err != nil {
			return nil, err
		}
	}
