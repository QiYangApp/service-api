...
func (uru *UserRoleUpdate) SetUpdateTime(ts timeutil.TimeStamp) *UserRoleUpdate {
	uru.mutation.ResetUpdateTime()
	uru.mutation.SetUpdateTime(ts)
	return uru
}

// AddUpdateTime adds ts to the "update_time" field.
func (uru *UserRoleUpdate) AddUpdateTime(ts timeutil.TimeStamp) *UserRoleUpdate {
	uru.mutation.AddUpdateTime(ts)
	return uru
}
...
func (uru *UserRoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uru.mutation.UpdateTime(); ok {
		_spec.SetField(userrole.FieldUpdateTime, field.TypeInt64, value)
	}
	if value, ok := uru.mutation.AddedUpdateTime(); ok {
		_spec.AddField(userrole.FieldUpdateTime, field.TypeInt64, value)
	}
...
// SetUpdateTime sets the "update_time" field.
func (uruo *UserRoleUpdateOne) SetUpdateTime(ts timeutil.TimeStamp) *UserRoleUpdateOne {
	uruo.mutation.ResetUpdateTime()
	uruo.mutation.SetUpdateTime(ts)
	return uruo
}

// AddUpdateTime adds ts to the "update_time" field.
func (uruo *UserRoleUpdateOne) AddUpdateTime(ts timeutil.TimeStamp) *UserRoleUpdateOne {
	uruo.mutation.AddUpdateTime(ts)
	return uruo
}
...
func (uruo *UserRoleUpdateOne) sqlSave(ctx context.Context) (_node *UserRole, err error) {
	...
	if value, ok := uruo.mutation.AddedUpdateTime(); ok {
		_spec.AddField(userrole.FieldUpdateTime, field.TypeInt64, value)
	}
