...
func (sdc *SourceDataCreate) SetCreateTime(ts timeutil.TimeStamp) *SourceDataCreate {
	sdc.mutation.SetCreateTime(ts)
	return sdc
}

// SetNillableCreateTime sets the "create_time" field if the given value is not nil.
func (sdc *SourceDataCreate) SetNillableCreateTime(ts *timeutil.TimeStamp) *SourceDataCreate {
	if ts != nil {
		sdc.SetCreateTime(*ts)
	}
	return sdc
}

// SetUpdateTime sets the "update_time" field.
func (sdc *SourceDataCreate) SetUpdateTime(ts timeutil.TimeStamp) *SourceDataCreate {
	sdc.mutation.SetUpdateTime(ts)
	return sdc
}
...
func (sdc *SourceDataCreate) createSpec() (*SourceData, *sqlgraph.CreateSpec) {
	...
	if value, ok := sdc.mutation.CreateTime(); ok {
		_spec.SetField(sourcedata.FieldCreateTime, field.TypeInt64, value)
