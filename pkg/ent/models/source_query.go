...
func (sq *SourceQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *SourceQuery) FirstIDX(ctx context.Context) int64 {
...
func (sq *SourceQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *SourceQuery) OnlyIDX(ctx context.Context) int64 {
...
func (sq *SourceQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (sq *SourceQuery) IDsX(ctx context.Context) []int64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SourceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(source.Table, source.Columns, sqlgraph.NewFieldSpec(source.FieldID, field.TypeInt64))
	_spec.From = sq.sql
