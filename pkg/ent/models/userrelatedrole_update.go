...
func (urru *UserRelatedRoleUpdate) SetUpdateTime(ts timeutil.TimeStamp) *UserRelatedRoleUpdate {
	urru.mutation.ResetUpdateTime()
	urru.mutation.SetUpdateTime(ts)
	return urru
}

// AddUpdateTime adds ts to the "update_time" field.
func (urru *UserRelatedRoleUpdate) AddUpdateTime(ts timeutil.TimeStamp) *UserRelatedRoleUpdate {
	urru.mutation.AddUpdateTime(ts)
	return urru
}
...
func (urru *UserRelatedRoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := urru.mutation.AddedUpdateTime(); ok {
		_spec.AddField(userrelatedrole.FieldUpdateTime, field.TypeInt64, value)
	}
...
// SetUpdateTime sets the "update_time" field.
func (urruo *UserRelatedRoleUpdateOne) SetUpdateTime(ts timeutil.TimeStamp) *UserRelatedRoleUpdateOne {
	urruo.mutation.ResetUpdateTime()
	urruo.mutation.SetUpdateTime(ts)
	return urruo
}

// AddUpdateTime adds ts to the "update_time" field.
func (urruo *UserRelatedRoleUpdateOne) AddUpdateTime(ts timeutil.TimeStamp) *UserRelatedRoleUpdateOne {
	urruo.mutation.AddUpdateTime(ts)
	return urruo
}
...
func (urruo *UserRelatedRoleUpdateOne) sqlSave(ctx context.Context) (_node *UserRelatedRole, err error) {
	...
	if value, ok := urruo.mutation.AddedUpdateTime(); ok {
		_spec.AddField(userrelatedrole.FieldUpdateTime, field.TypeInt64, value)
	}
