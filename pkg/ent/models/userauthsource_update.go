...
func (uasu *UserAuthSourceUpdate) SetUpdateTime(ts timeutil.TimeStamp) *UserAuthSourceUpdate {
	uasu.mutation.ResetUpdateTime()
	uasu.mutation.SetUpdateTime(ts)
	return uasu
}

// AddUpdateTime adds ts to the "update_time" field.
func (uasu *UserAuthSourceUpdate) AddUpdateTime(ts timeutil.TimeStamp) *UserAuthSourceUpdate {
	uasu.mutation.AddUpdateTime(ts)
	return uasu
}
...
func (uasu *UserAuthSourceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uasu.mutation.UpdateTime(); ok {
		_spec.SetField(userauthsource.FieldUpdateTime, field.TypeInt64, value)
	}
	if value, ok := uasu.mutation.AddedUpdateTime(); ok {
		_spec.AddField(userauthsource.FieldUpdateTime, field.TypeInt64, value)
	}
...
// SetUpdateTime sets the "update_time" field.
func (uasuo *UserAuthSourceUpdateOne) SetUpdateTime(ts timeutil.TimeStamp) *UserAuthSourceUpdateOne {
	uasuo.mutation.ResetUpdateTime()
	uasuo.mutation.SetUpdateTime(ts)
	return uasuo
}

// AddUpdateTime adds ts to the "update_time" field.
func (uasuo *UserAuthSourceUpdateOne) AddUpdateTime(ts timeutil.TimeStamp) *UserAuthSourceUpdateOne {
	uasuo.mutation.AddUpdateTime(ts)
	return uasuo
}
...
func (uasuo *UserAuthSourceUpdateOne) sqlSave(ctx context.Context) (_node *UserAuthSource, err error) {
	...
	if value, ok := uasuo.mutation.AddedUpdateTime(); ok {
		_spec.AddField(userauthsource.FieldUpdateTime, field.TypeInt64, value)
	}
