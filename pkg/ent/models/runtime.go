...
func init() {
	...
	accesstokenDescUpdateTime := accesstokenFields[11].Descriptor()
	// accesstoken.UpdateDefaultUpdateTime holds the default value on update for the update_time field.
	accesstoken.UpdateDefaultUpdateTime = accesstokenDescUpdateTime.UpdateDefault.(func() timeutil.TimeStamp)
	accountsFields := schema.Accounts{}.Fields()
	_ = accountsFields
	// accountsDescIsPrimary is the schema descriptor for is_primary field.
	accountsDescIsPrimary := accountsFields[6].Descriptor()
	...
	accountsDescCreateTime := accountsFields[7].Descriptor()
	...
	accountsDescUpdateTime := accountsFields[8].Descriptor()
	...
	userDescPasswdSalt := userFields[3].Descriptor()
	...
	userDescPasswdHashAlgo := userFields[4].Descriptor()
	...
	userDescLoginName := userFields[8].Descriptor()
	...
	userDescLoginSource := userFields[9].Descriptor()
	...
	userDescIsRestricted := userFields[11].Descriptor()
	...
	userDescProhibitLogin := userFields[13].Descriptor()
	...
	userDescUpdateTime := userFields[15].Descriptor()
	...
	userauthsource.DefaultCreateTime = userauthsourceDescCreateTime.Default.(func() time.Time)
	...
	// userauthsource.DefaultUpdateTime holds the default value on creation for the update_time field.
	userauthsource.DefaultUpdateTime = userauthsourceDescUpdateTime.Default.(func() time.Time)
	// userauthsource.UpdateDefaultUpdateTime holds the default value on update for the update_time field.
	userauthsource.UpdateDefaultUpdateTime = userauthsourceDescUpdateTime.UpdateDefault.(func() time.Time)
	...
	userrelatedrole.DefaultCreateTime = userrelatedroleDescCreateTime.Default.(func() time.Time)
	...
	// userrelatedrole.DefaultUpdateTime holds the default value on creation for the update_time field.
	userrelatedrole.DefaultUpdateTime = userrelatedroleDescUpdateTime.Default.(func() time.Time)
	// userrelatedrole.UpdateDefaultUpdateTime holds the default value on update for the update_time field.
	userrelatedrole.UpdateDefaultUpdateTime = userrelatedroleDescUpdateTime.UpdateDefault.(func() time.Time)
