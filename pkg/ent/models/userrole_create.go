...
func (urc *UserRoleCreate) SetCreateTime(ts timeutil.TimeStamp) *UserRoleCreate {
	urc.mutation.SetCreateTime(ts)
	return urc
}

// SetNillableCreateTime sets the "create_time" field if the given value is not nil.
func (urc *UserRoleCreate) SetNillableCreateTime(ts *timeutil.TimeStamp) *UserRoleCreate {
	if ts != nil {
		urc.SetCreateTime(*ts)
	}
	return urc
}

// SetUpdateTime sets the "update_time" field.
func (urc *UserRoleCreate) SetUpdateTime(ts timeutil.TimeStamp) *UserRoleCreate {
	urc.mutation.SetUpdateTime(ts)
	return urc
}
...
func (urc *UserRoleCreate) createSpec() (*UserRole, *sqlgraph.CreateSpec) {
	...
	if value, ok := urc.mutation.CreateTime(); ok {
		_spec.SetField(userrole.FieldCreateTime, field.TypeInt64, value)
