...
var (
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "theme", Type: field.TypeString, Size: 32},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserAuthSourcesColumns[1], UserAuthSourcesColumns[5], UserAuthSourcesColumns[6]},
			},
			{
				Name:    "userauthsource_create_time",
				Unique:  false,
				Columns: []*schema.Column{UserAuthSourcesColumns[14]},
			},
			{
				Name:    "userauthsource_update_time",
				Unique:  false,
				Columns: []*schema.Column{UserAuthSourcesColumns[15]},
			},
		},
	}
