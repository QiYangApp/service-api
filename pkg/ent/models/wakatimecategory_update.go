...
func (wcu *WakatimeCategoryUpdate) SetWakatimeID(i int64) *WakatimeCategoryUpdate {
	wcu.mutation.ResetWakatimeID()
	wcu.mutation.SetWakatimeID(i)
	return wcu
}

// SetNillableWakatimeID sets the "wakatime_id" field if the given value is not nil.
func (wcu *WakatimeCategoryUpdate) SetNillableWakatimeID(i *int64) *WakatimeCategoryUpdate {
	if i != nil {
		wcu.SetWakatimeID(*i)
	}
	return wcu
...
func (wcu *WakatimeCategoryUpdate) AddWakatimeID(i int64) *WakatimeCategoryUpdate {
	wcu.mutation.AddWakatimeID(i)
	return wcu
}
...
func (wcu *WakatimeCategoryUpdate) SetUpdateTime(ts timeutil.TimeStamp) *WakatimeCategoryUpdate {
	wcu.mutation.ResetUpdateTime()
	wcu.mutation.SetUpdateTime(ts)
	return wcu
}

// AddUpdateTime adds ts to the "update_time" field.
func (wcu *WakatimeCategoryUpdate) AddUpdateTime(ts timeutil.TimeStamp) *WakatimeCategoryUpdate {
	wcu.mutation.AddUpdateTime(ts)
	return wcu
}
...
func (wcu *WakatimeCategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := wcu.mutation.AddedWakatimeID(); ok {
		_spec.AddField(wakatimecategory.FieldWakatimeID, field.TypeInt64, value)
	}
	...
	if value, ok := wcu.mutation.AddedUpdateTime(); ok {
		_spec.AddField(wakatimecategory.FieldUpdateTime, field.TypeInt64, value)
	}
...
// SetWakatimeID sets the "wakatime_id" field.
func (wcuo *WakatimeCategoryUpdateOne) SetWakatimeID(i int64) *WakatimeCategoryUpdateOne {
	wcuo.mutation.ResetWakatimeID()
	wcuo.mutation.SetWakatimeID(i)
	return wcuo
}

// SetNillableWakatimeID sets the "wakatime_id" field if the given value is not nil.
func (wcuo *WakatimeCategoryUpdateOne) SetNillableWakatimeID(i *int64) *WakatimeCategoryUpdateOne {
	if i != nil {
		wcuo.SetWakatimeID(*i)
	}
	return wcuo
}

// AddWakatimeID adds i to the "wakatime_id" field.
func (wcuo *WakatimeCategoryUpdateOne) AddWakatimeID(i int64) *WakatimeCategoryUpdateOne {
	wcuo.mutation.AddWakatimeID(i)
	return wcuo
}
...
// SetUpdateTime sets the "update_time" field.
func (wcuo *WakatimeCategoryUpdateOne) SetUpdateTime(ts timeutil.TimeStamp) *WakatimeCategoryUpdateOne {
	wcuo.mutation.ResetUpdateTime()
	wcuo.mutation.SetUpdateTime(ts)
	return wcuo
}

// AddUpdateTime adds ts to the "update_time" field.
func (wcuo *WakatimeCategoryUpdateOne) AddUpdateTime(ts timeutil.TimeStamp) *WakatimeCategoryUpdateOne {
	wcuo.mutation.AddUpdateTime(ts)
	return wcuo
}
...
func (wcuo *WakatimeCategoryUpdateOne) sqlSave(ctx context.Context) (_node *WakatimeCategory, err error) {
	...
	if value, ok := wcuo.mutation.AddedWakatimeID(); ok {
		_spec.AddField(wakatimecategory.FieldWakatimeID, field.TypeInt64, value)
	}
	...
	if value, ok := wcuo.mutation.AddedUpdateTime(); ok {
		_spec.AddField(wakatimecategory.FieldUpdateTime, field.TypeInt64, value)
	}
