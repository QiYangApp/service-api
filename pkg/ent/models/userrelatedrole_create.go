...
func (urrc *UserRelatedRoleCreate) SetCreateTime(t time.Time) *UserRelatedRoleCreate {
	urrc.mutation.SetCreateTime(t)
	return urrc
}

// SetNillableCreateTime sets the "create_time" field if the given value is not nil.
func (urrc *UserRelatedRoleCreate) SetNillableCreateTime(t *time.Time) *UserRelatedRoleCreate {
	if t != nil {
		urrc.SetCreateTime(*t)
	}
	return urrc
}

// SetUpdateTime sets the "update_time" field.
func (urrc *UserRelatedRoleCreate) SetUpdateTime(t time.Time) *UserRelatedRoleCreate {
	urrc.mutation.SetUpdateTime(t)
	return urrc
}

// SetNillableUpdateTime sets the "update_time" field if the given value is not nil.
func (urrc *UserRelatedRoleCreate) SetNillableUpdateTime(t *time.Time) *UserRelatedRoleCreate {
	if t != nil {
		urrc.SetUpdateTime(*t)
	}
	return urrc
}
...
func (urrc *UserRelatedRoleCreate) defaults() {
	...
	if _, ok := urrc.mutation.UpdateTime(); !ok {
		v := userrelatedrole.DefaultUpdateTime()
		urrc.mutation.SetUpdateTime(v)
	}
}
...
func (urrc *UserRelatedRoleCreate) createSpec() (*UserRelatedRole, *sqlgraph.CreateSpec) {
	...
	if value, ok := urrc.mutation.CreateTime(); ok {
		_spec.SetField(userrelatedrole.FieldCreateTime, field.TypeTime, value)
