...
func (aq *AccountsQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (aq *AccountsQuery) FirstIDX(ctx context.Context) int64 {
...
func (aq *AccountsQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (aq *AccountsQuery) OnlyIDX(ctx context.Context) int64 {
...
func (aq *AccountsQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (aq *AccountsQuery) IDsX(ctx context.Context) []int64 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AccountsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(accounts.Table, accounts.Columns, sqlgraph.NewFieldSpec(accounts.FieldID, field.TypeInt64))
	_spec.From = aq.sql
