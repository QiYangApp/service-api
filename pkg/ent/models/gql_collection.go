...
func (at *AccessTokenQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
...
func (a *AccountsQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (mrrp *MemberRoleRelatedPermissionQuery) CollectFields(ctx context.Context, satisfies ...string) (*MemberRoleRelatedPermissionQuery, error) {
	...
	if err := mrrp.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return mrrp, nil
}

func (mrrp *MemberRoleRelatedPermissionQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (pg *PermissionGroupQuery) CollectFields(ctx context.Context, satisfies ...string) (*PermissionGroupQuery, error) {
	...
	if err := pg.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return pg, nil
}

func (pg *PermissionGroupQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (prr *PermissionRelatedRouterQuery) CollectFields(ctx context.Context, satisfies ...string) (*PermissionRelatedRouterQuery, error) {
	...
	if err := prr.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return prr, nil
}

func (prr *PermissionRelatedRouterQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (r *RouterQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (s *SourceQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (sd *SourceDataQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (tf *TwoFactorQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (uas *UserAuthSourceQuery) CollectFields(ctx context.Context, satisfies ...string) (*UserAuthSourceQuery, error) {
	...
	if err := uas.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return uas, nil
}

func (uas *UserAuthSourceQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (urr *UserRelatedRoleQuery) CollectFields(ctx context.Context, satisfies ...string) (*UserRelatedRoleQuery, error) {
	...
	if err := urr.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return urr, nil
}

func (urr *UserRelatedRoleQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (ur *UserRoleQuery) CollectFields(ctx context.Context, satisfies ...string) (*UserRoleQuery, error) {
	...
	if err := ur.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return ur, nil
}

func (ur *UserRoleQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (w *WakatimeQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (wc *WakatimeCategoryQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeCategoryQuery, error) {
	...
	if err := wc.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return wc, nil
}

func (wc *WakatimeCategoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (wd *WakatimeDependencyQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeDependencyQuery, error) {
	...
	if err := wd.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return wd, nil
}

func (wd *WakatimeDependencyQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
...
func (wd *WakatimeDurationQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (we *WakatimeEditorQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeEditorQuery, error) {
	...
	if err := we.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return we, nil
}

func (we *WakatimeEditorQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (we *WakatimeEntityQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (wgt *WakatimeGrandTotalQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeGrandTotalQuery, error) {
	...
	if err := wgt.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return wgt, nil
}

func (wgt *WakatimeGrandTotalQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (whb *WakatimeHeartBeatQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeHeartBeatQuery, error) {
	...
	if err := whb.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return whb, nil
}

func (whb *WakatimeHeartBeatQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (wl *WakatimeLanguageQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeLanguageQuery, error) {
	...
	if err := wl.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return wl, nil
}

func (wl *WakatimeLanguageQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (wp *WakatimeProjectQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeProjectQuery, error) {
	...
	if err := wp.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return wp, nil
}

func (wp *WakatimeProjectQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (wpd *WakatimeProjectDurationQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeProjectDurationQuery, error) {
	...
	if err := wpd.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return wpd, nil
}

func (wpd *WakatimeProjectDurationQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (wpi *WakatimeProjectInfoQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeProjectInfoQuery, error) {
	...
	if err := wpi.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return wpi, nil
}

func (wpi *WakatimeProjectInfoQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (ws *WakatimeSystemQuery) CollectFields(ctx context.Context, satisfies ...string) (*WakatimeSystemQuery, error) {
	...
	if err := ws.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return ws, nil
}

func (ws *WakatimeSystemQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}
...
func (wac *WebAuthnCredentialQuery) CollectFields(ctx context.Context, satisfies ...string) (*WebAuthnCredentialQuery, error) {
	...
	if err := wac.collectField(ctx, false, graphql.GetOperationContext(ctx), fc.Field, nil, satisfies...); err != nil {
		return nil, err
	}
	return wac, nil
}

func (wac *WebAuthnCredentialQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
