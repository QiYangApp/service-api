...
func (sdu *SourceDataUpdate) SetUpdateTime(ts timeutil.TimeStamp) *SourceDataUpdate {
	sdu.mutation.ResetUpdateTime()
	sdu.mutation.SetUpdateTime(ts)
	return sdu
}

// AddUpdateTime adds ts to the "update_time" field.
func (sdu *SourceDataUpdate) AddUpdateTime(ts timeutil.TimeStamp) *SourceDataUpdate {
	sdu.mutation.AddUpdateTime(ts)
	return sdu
}
...
func (sdu *SourceDataUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := sdu.mutation.UpdateTime(); ok {
		_spec.SetField(sourcedata.FieldUpdateTime, field.TypeInt64, value)
	}
	if value, ok := sdu.mutation.AddedUpdateTime(); ok {
		_spec.AddField(sourcedata.FieldUpdateTime, field.TypeInt64, value)
	}
...
// SetUpdateTime sets the "update_time" field.
func (sduo *SourceDataUpdateOne) SetUpdateTime(ts timeutil.TimeStamp) *SourceDataUpdateOne {
	sduo.mutation.ResetUpdateTime()
	sduo.mutation.SetUpdateTime(ts)
	return sduo
}

// AddUpdateTime adds ts to the "update_time" field.
func (sduo *SourceDataUpdateOne) AddUpdateTime(ts timeutil.TimeStamp) *SourceDataUpdateOne {
	sduo.mutation.AddUpdateTime(ts)
	return sduo
}
...
func (sduo *SourceDataUpdateOne) sqlSave(ctx context.Context) (_node *SourceData, err error) {
	...
	if value, ok := sduo.mutation.AddedUpdateTime(); ok {
		_spec.AddField(sourcedata.FieldUpdateTime, field.TypeInt64, value)
	}
