...
func (uu *UserUpdate) SetUpdateTime(ts timeutil.TimeStamp) *UserUpdate {
	uu.mutation.ResetUpdateTime()
	uu.mutation.SetUpdateTime(ts)
	return uu
}

// AddUpdateTime adds ts to the "update_time" field.
func (uu *UserUpdate) AddUpdateTime(ts timeutil.TimeStamp) *UserUpdate {
	uu.mutation.AddUpdateTime(ts)
	return uu
}
...
// SetUpdateTime sets the "update_time" field.
func (uuo *UserUpdateOne) SetUpdateTime(ts timeutil.TimeStamp) *UserUpdateOne {
	uuo.mutation.ResetUpdateTime()
	uuo.mutation.SetUpdateTime(ts)
	return uuo
}

// AddUpdateTime adds ts to the "update_time" field.
func (uuo *UserUpdateOne) AddUpdateTime(ts timeutil.TimeStamp) *UserUpdateOne {
	uuo.mutation.AddUpdateTime(ts)
	return uuo
}
