...
func (wdu *WakatimeDependencyUpdate) SetMemberID(u uuid.UUID) *WakatimeDependencyUpdate {
	wdu.mutation.SetMemberID(u)
	return wdu
}

// SetNillableMemberID sets the "member_id" field if the given value is not nil.
func (wdu *WakatimeDependencyUpdate) SetNillableMemberID(u *uuid.UUID) *WakatimeDependencyUpdate {
	if u != nil {
		wdu.SetMemberID(*u)
	}
	return wdu
...
func (wdu *WakatimeDependencyUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := wdu.mutation.MemberID(); ok {
...
// SetMemberID sets the "member_id" field.
func (wduo *WakatimeDependencyUpdateOne) SetMemberID(u uuid.UUID) *WakatimeDependencyUpdateOne {
	wduo.mutation.SetMemberID(u)
	return wduo
}

// SetNillableMemberID sets the "member_id" field if the given value is not nil.
func (wduo *WakatimeDependencyUpdateOne) SetNillableMemberID(u *uuid.UUID) *WakatimeDependencyUpdateOne {
	if u != nil {
		wduo.SetMemberID(*u)
	}
	return wduo
...
func (wduo *WakatimeDependencyUpdateOne) sqlSave(ctx context.Context) (_node *WakatimeDependency, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "WakatimeDependency.id" for update`)}
	}
	...
	if value, ok := wduo.mutation.MemberID(); ok {
		_spec.SetField(wakatimedependency.FieldMemberID, field.TypeUUID, value)
	}
