...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			wakatime.Table:                    wakatime.ValidColumn,
			wakatimecategory.Table:            wakatimecategory.ValidColumn,
			wakatimedependency.Table:          wakatimedependency.ValidColumn,
			wakatimeduration.Table:            wakatimeduration.ValidColumn,
			wakatimeeditor.Table:              wakatimeeditor.ValidColumn,
			wakatimeentity.Table:              wakatimeentity.ValidColumn,
			wakatimegrandtotal.Table:          wakatimegrandtotal.ValidColumn,
			wakatimeheartbeat.Table:           wakatimeheartbeat.ValidColumn,
			wakatimelanguage.Table:            wakatimelanguage.ValidColumn,
			wakatimeproject.Table:             wakatimeproject.ValidColumn,
