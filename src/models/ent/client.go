...
import (
	...
	"service-api/src/models/ent/wakatimeentity"
	...
	"service-api/src/models/ent/wakatimesystem"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Router, c.SourceData, c.Wakatime, c.WakatimeCategory, c.WakatimeDependency,
		c.WakatimeDuration, c.WakatimeEditor, c.WakatimeEntity, c.WakatimeGrandTotal,
		c.WakatimeHeartBeat, c.WakatimeLanguage, c.WakatimeProject,
		c.WakatimeProjectDuration, c.WakatimeProjectInfo, c.WakatimeSystem,
	} {
		n.Use(hooks...)
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *MemberAuthorizeLogClient) MapCreateBulk(slice any, setFunc func(*MemberAuthorizeLogCreate, int)) *MemberAuthorizeLogCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &MemberAuthorizeLogCreateBulk{err: fmt.Errorf("calling to MemberAuthorizeLogClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*MemberAuthorizeLogCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *MemberRelatedRoleClient) MapCreateBulk(slice any, setFunc func(*MemberRelatedRoleCreate, int)) *MemberRelatedRoleCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &MemberRelatedRoleCreateBulk{err: fmt.Errorf("calling to MemberRelatedRoleClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*MemberRelatedRoleCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *WakatimeClient) UpdateOneID(id uuid.UUID) *WakatimeUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *WakatimeClient) DeleteOneID(id uuid.UUID) *WakatimeDeleteOne {
...
func (c *WakatimeClient) Get(ctx context.Context, id uuid.UUID) (*Wakatime, error) {
	return c.Query().Where(wakatime.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *WakatimeClient) GetX(ctx context.Context, id uuid.UUID) *Wakatime {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *WakatimeClient) mutate(ctx context.Context, m *WakatimeMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown Wakatime mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeCategoryClient) mutate(ctx context.Context, m *WakatimeCategoryMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeCategory mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeDependencyClient) mutate(ctx context.Context, m *WakatimeDependencyMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeDependency mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeDurationClient) mutate(ctx context.Context, m *WakatimeDurationMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeDuration mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeEditorClient) mutate(ctx context.Context, m *WakatimeEditorMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeEditor mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeEntityClient) mutate(ctx context.Context, m *WakatimeEntityMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeEntity mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeGrandTotalClient) mutate(ctx context.Context, m *WakatimeGrandTotalMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeGrandTotal mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeHeartBeatClient) mutate(ctx context.Context, m *WakatimeHeartBeatMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeHeartBeat mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeLanguageClient) mutate(ctx context.Context, m *WakatimeLanguageMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeLanguage mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeProjectClient) mutate(ctx context.Context, m *WakatimeProjectMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeProject mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeProjectDurationClient) mutate(ctx context.Context, m *WakatimeProjectDurationMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeProjectDuration mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeProjectInfoClient) mutate(ctx context.Context, m *WakatimeProjectInfoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeProjectInfo mutation op: %q", m.Op())
	}
}
...
func (c *WakatimeSystemClient) mutate(ctx context.Context, m *WakatimeSystemMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown WakatimeSystem mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		...
		MemberRoleRelatedPermission, PermissionGroup, PermissionRelatedRouter, Router,
		SourceData, Wakatime, WakatimeCategory, WakatimeDependency, WakatimeDuration,
		WakatimeEditor, WakatimeEntity, WakatimeGrandTotal, WakatimeHeartBeat,
		WakatimeLanguage, WakatimeProject, WakatimeProjectDuration,
