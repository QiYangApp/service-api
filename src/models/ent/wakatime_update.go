...
func (wu *WakatimeUpdate) SetUpdateTime(t time.Time) *WakatimeUpdate {
	wu.mutation.SetUpdateTime(t)
	return wu
}

// SetMemberID sets the "member_id" field.
func (wu *WakatimeUpdate) SetMemberID(u uuid.UUID) *WakatimeUpdate {
	wu.mutation.SetMemberID(u)
	return wu
}

// SetNillableMemberID sets the "member_id" field if the given value is not nil.
func (wu *WakatimeUpdate) SetNillableMemberID(u *uuid.UUID) *WakatimeUpdate {
	if u != nil {
		wu.SetMemberID(*u)
	}
	return wu
...
func (wu *WakatimeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(wakatime.Table, wakatime.Columns, sqlgraph.NewFieldSpec(wakatime.FieldID, field.TypeUUID))
	...
	if value, ok := wu.mutation.MemberID(); ok {
...
// SetUpdateTime sets the "update_time" field.
func (wuo *WakatimeUpdateOne) SetUpdateTime(t time.Time) *WakatimeUpdateOne {
	wuo.mutation.SetUpdateTime(t)
	return wuo
}

// SetMemberID sets the "member_id" field.
func (wuo *WakatimeUpdateOne) SetMemberID(u uuid.UUID) *WakatimeUpdateOne {
	wuo.mutation.SetMemberID(u)
	return wuo
}

// SetNillableMemberID sets the "member_id" field if the given value is not nil.
func (wuo *WakatimeUpdateOne) SetNillableMemberID(u *uuid.UUID) *WakatimeUpdateOne {
	if u != nil {
		wuo.SetMemberID(*u)
	}
	return wuo
...
func (wuo *WakatimeUpdateOne) sqlSave(ctx context.Context) (_node *Wakatime, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "Wakatime.id" for update`)}
	}
	...
	if value, ok := wuo.mutation.MemberID(); ok {
		_spec.SetField(wakatime.FieldMemberID, field.TypeUUID, value)
	}
