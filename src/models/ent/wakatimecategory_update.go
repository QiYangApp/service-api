...
func (wcu *WakatimeCategoryUpdate) SetMemberID(u uuid.UUID) *WakatimeCategoryUpdate {
	wcu.mutation.SetMemberID(u)
	return wcu
}

// SetNillableMemberID sets the "member_id" field if the given value is not nil.
func (wcu *WakatimeCategoryUpdate) SetNillableMemberID(u *uuid.UUID) *WakatimeCategoryUpdate {
	if u != nil {
		wcu.SetMemberID(*u)
	}
	return wcu
...
func (wcu *WakatimeCategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(wakatimecategory.Table, wakatimecategory.Columns, sqlgraph.NewFieldSpec(wakatimecategory.FieldID, field.TypeUUID))
	...
	if value, ok := wcu.mutation.MemberID(); ok {
...
// SetMemberID sets the "member_id" field.
func (wcuo *WakatimeCategoryUpdateOne) SetMemberID(u uuid.UUID) *WakatimeCategoryUpdateOne {
	wcuo.mutation.SetMemberID(u)
	return wcuo
}

// SetNillableMemberID sets the "member_id" field if the given value is not nil.
func (wcuo *WakatimeCategoryUpdateOne) SetNillableMemberID(u *uuid.UUID) *WakatimeCategoryUpdateOne {
	if u != nil {
		wcuo.SetMemberID(*u)
	}
	return wcuo
...
func (wcuo *WakatimeCategoryUpdateOne) sqlSave(ctx context.Context) (_node *WakatimeCategory, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "WakatimeCategory.id" for update`)}
	}
	...
	if value, ok := wcuo.mutation.MemberID(); ok {
		_spec.SetField(wakatimecategory.FieldMemberID, field.TypeUUID, value)
	}
