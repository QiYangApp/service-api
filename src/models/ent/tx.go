...
func (tx *Tx) init() {
	...
	tx.Wakatime = NewWakatimeClient(tx.config)
	tx.WakatimeCategory = NewWakatimeCategoryClient(tx.config)
	tx.WakatimeDependency = NewWakatimeDependencyClient(tx.config)
	tx.WakatimeDuration = NewWakatimeDurationClient(tx.config)
	tx.WakatimeEditor = NewWakatimeEditorClient(tx.config)
	tx.WakatimeEntity = NewWakatimeEntityClient(tx.config)
	tx.WakatimeGrandTotal = NewWakatimeGrandTotalClient(tx.config)
	tx.WakatimeHeartBeat = NewWakatimeHeartBeatClient(tx.config)
	tx.WakatimeLanguage = NewWakatimeLanguageClient(tx.config)
	tx.WakatimeProject = NewWakatimeProjectClient(tx.config)
