...
func (sdu *SourceDataUpdate) SetMemberID(u uuid.UUID) *SourceDataUpdate {
	sdu.mutation.SetMemberID(u)
	return sdu
}

// SetNillableMemberID sets the "member_id" field if the given value is not nil.
func (sdu *SourceDataUpdate) SetNillableMemberID(u *uuid.UUID) *SourceDataUpdate {
	if u != nil {
		sdu.SetMemberID(*u)
	}
	return sdu
...
func (sdu *SourceDataUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := sdu.mutation.MemberID(); ok {
...
// SetMemberID sets the "member_id" field.
func (sduo *SourceDataUpdateOne) SetMemberID(u uuid.UUID) *SourceDataUpdateOne {
	sduo.mutation.SetMemberID(u)
	return sduo
}

// SetNillableMemberID sets the "member_id" field if the given value is not nil.
func (sduo *SourceDataUpdateOne) SetNillableMemberID(u *uuid.UUID) *SourceDataUpdateOne {
	if u != nil {
		sduo.SetMemberID(*u)
	}
	return sduo
...
func (sduo *SourceDataUpdateOne) sqlSave(ctx context.Context) (_node *SourceData, err error) {
	...
	if value, ok := sduo.mutation.MemberID(); ok {
		_spec.SetField(sourcedata.FieldMemberID, field.TypeUUID, value)
	}
