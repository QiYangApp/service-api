...
func And(predicates ...predicate.MemberRoleRelatedPermission) predicate.MemberRoleRelatedPermission {
	return predicate.MemberRoleRelatedPermission(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
