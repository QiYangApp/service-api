...
func (prrq *PermissionRelatedRouterQuery) Order(o ...OrderFunc) *PermissionRelatedRouterQuery {
...
func (prrq *PermissionRelatedRouterQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (prrq *PermissionRelatedRouterQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (prrq *PermissionRelatedRouterQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (prrq *PermissionRelatedRouterQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (prrq *PermissionRelatedRouterQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (prrq *PermissionRelatedRouterQuery) IDsX(ctx context.Context) []uuid.UUID {
...
//		GroupBy(permissionrelatedrouter.FieldCreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.PermissionRelatedRouter.Query().
//		Select(permissionrelatedrouter.FieldCreateTime).
//		Scan(ctx, &v)
...
func (prrq *PermissionRelatedRouterQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(permissionrelatedrouter.Table, permissionrelatedrouter.Columns, sqlgraph.NewFieldSpec(permissionrelatedrouter.FieldID, field.TypeUUID))
	_spec.From = prrq.sql
