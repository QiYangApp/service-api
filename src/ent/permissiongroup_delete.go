...
func (pgd *PermissionGroupDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, PermissionGroupMutation](ctx, pgd.sqlExec, pgd.mutation, pgd.hooks)
}
...
func (pgd *PermissionGroupDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(permissiongroup.Table, sqlgraph.NewFieldSpec(permissiongroup.FieldID, field.TypeUUID))
