...
func (prrc *PermissionRelatedRouterCreate) SetCreateTime(t time.Time) *PermissionRelatedRouterCreate {
	prrc.mutation.SetCreateTime(t)
	return prrc
}

// SetNillableCreateTime sets the "create_time" field if the given value is not nil.
func (prrc *PermissionRelatedRouterCreate) SetNillableCreateTime(t *time.Time) *PermissionRelatedRouterCreate {
	if t != nil {
		prrc.SetCreateTime(*t)
	}
	return prrc
}

// SetUpdateTime sets the "update_time" field.
func (prrc *PermissionRelatedRouterCreate) SetUpdateTime(t time.Time) *PermissionRelatedRouterCreate {
	prrc.mutation.SetUpdateTime(t)
	return prrc
}

// SetNillableUpdateTime sets the "update_time" field if the given value is not nil.
func (prrc *PermissionRelatedRouterCreate) SetNillableUpdateTime(t *time.Time) *PermissionRelatedRouterCreate {
	if t != nil {
		prrc.SetUpdateTime(*t)
	}
	return prrc
}
...
func (prrc *PermissionRelatedRouterCreate) SetID(u uuid.UUID) *PermissionRelatedRouterCreate {
	prrc.mutation.SetID(u)
	return prrc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (prrc *PermissionRelatedRouterCreate) SetNillableID(u *uuid.UUID) *PermissionRelatedRouterCreate {
	if u != nil {
		prrc.SetID(*u)
	}
	return prrc
...
func (prrc *PermissionRelatedRouterCreate) Save(ctx context.Context) (*PermissionRelatedRouter, error) {
	prrc.defaults()
	return withHooks[*PermissionRelatedRouter, PermissionRelatedRouterMutation](ctx, prrc.sqlSave, prrc.mutation, prrc.hooks)
}
...
func (prrc *PermissionRelatedRouterCreate) defaults() {
	...
	if _, ok := prrc.mutation.UpdateTime(); !ok {
		v := permissionrelatedrouter.DefaultUpdateTime()
		prrc.mutation.SetUpdateTime(v)
	}
	if _, ok := prrc.mutation.ID(); !ok {
		v := permissionrelatedrouter.DefaultID()
		prrc.mutation.SetID(v)
	}
}
...
func (prrc *PermissionRelatedRouterCreate) check() error {
	if _, ok := prrc.mutation.CreateTime(); !ok {
		return &ValidationError{Name: "create_time", err: errors.New(`ent: missing required field "PermissionRelatedRouter.create_time"`)}
	}
	if _, ok := prrc.mutation.UpdateTime(); !ok {
		return &ValidationError{Name: "update_time", err: errors.New(`ent: missing required field "PermissionRelatedRouter.update_time"`)}
	}
	if _, ok := prrc.mutation.RouterID(); !ok {
		return &ValidationError{Name: "router_id", err: errors.New(`ent: missing required field "PermissionRelatedRouter.router_id"`)}
	}
	if _, ok := prrc.mutation.PermissionGroupID(); !ok {
		return &ValidationError{Name: "permission_group_id", err: errors.New(`ent: missing required field "PermissionRelatedRouter.permission_group_id"`)}
	}
	return nil
}
...
func (prrc *PermissionRelatedRouterCreate) createSpec() (*PermissionRelatedRouter, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(permissionrelatedrouter.Table, sqlgraph.NewFieldSpec(permissionrelatedrouter.FieldID, field.TypeUUID))
	)
	...
	if value, ok := prrc.mutation.CreateTime(); ok {
		_spec.SetField(permissionrelatedrouter.FieldCreateTime, field.TypeTime, value)
		_node.CreateTime = value
	}
	if value, ok := prrc.mutation.UpdateTime(); ok {
		_spec.SetField(permissionrelatedrouter.FieldUpdateTime, field.TypeTime, value)
