...
func (*MemberAuthorizeLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case memberauthorizelog.FieldChannel, memberauthorizelog.FieldDevice, memberauthorizelog.FieldDeviceDetail, memberauthorizelog.FieldIpv4, memberauthorizelog.FieldIpv6, memberauthorizelog.FieldSnapshot:
		...
		default:
			return nil, fmt.Errorf("unexpected column %q for type MemberAuthorizeLog", columns[i])
		}
	}
	return values, nil
}
...
func (mal *MemberAuthorizeLog) String() string {
	...
	builder.WriteString(mal.Ipv4)
	builder.WriteString(", ")
	builder.WriteString("ipv6=")
	builder.WriteString(mal.Ipv6)
	builder.WriteString(", ")
