...
func (pgc *PermissionGroupCreate) SetCreateTime(t time.Time) *PermissionGroupCreate {
	pgc.mutation.SetCreateTime(t)
	return pgc
}

// SetNillableCreateTime sets the "create_time" field if the given value is not nil.
func (pgc *PermissionGroupCreate) SetNillableCreateTime(t *time.Time) *PermissionGroupCreate {
	if t != nil {
		pgc.SetCreateTime(*t)
	}
	return pgc
...
func (pgc *PermissionGroupCreate) SetUpdateTime(t time.Time) *PermissionGroupCreate {
	pgc.mutation.SetUpdateTime(t)
	return pgc
}

// SetNillableUpdateTime sets the "update_time" field if the given value is not nil.
func (pgc *PermissionGroupCreate) SetNillableUpdateTime(t *time.Time) *PermissionGroupCreate {
	if t != nil {
		pgc.SetUpdateTime(*t)
	}
	return pgc
...
func (pgc *PermissionGroupCreate) SetIcon(s string) *PermissionGroupCreate {
	pgc.mutation.SetIcon(s)
	return pgc
}

// SetNillableIcon sets the "icon" field if the given value is not nil.
func (pgc *PermissionGroupCreate) SetNillableIcon(s *string) *PermissionGroupCreate {
	if s != nil {
		pgc.SetIcon(*s)
	}
	return pgc
...
func (pgc *PermissionGroupCreate) SetState(s string) *PermissionGroupCreate {
	pgc.mutation.SetState(s)
	return pgc
}

// SetNillableState sets the "state" field if the given value is not nil.
func (pgc *PermissionGroupCreate) SetNillableState(s *string) *PermissionGroupCreate {
	if s != nil {
		pgc.SetState(*s)
	}
	return pgc
...
func (pgc *PermissionGroupCreate) SetNillableID(u *uuid.UUID) *PermissionGroupCreate {
	if u != nil {
		pgc.SetID(*u)
	}
	return pgc
...
func (pgc *PermissionGroupCreate) Save(ctx context.Context) (*PermissionGroup, error) {
	pgc.defaults()
	return withHooks[*PermissionGroup, PermissionGroupMutation](ctx, pgc.sqlSave, pgc.mutation, pgc.hooks)
}
...
func (pgc *PermissionGroupCreate) check() error {
	...
	if _, ok := pgc.mutation.PermissionName(); !ok {
		return &ValidationError{Name: "permission_name", err: errors.New(`ent: missing required field "PermissionGroup.permission_name"`)}
	}
	...
	if _, ok := pgc.mutation.Icon(); !ok {
		return &ValidationError{Name: "icon", err: errors.New(`ent: missing required field "PermissionGroup.icon"`)}
	}
	if v, ok := pgc.mutation.Icon(); ok {
		if err := permissiongroup.IconValidator(v); err != nil {
			return &ValidationError{Name: "icon", err: fmt.Errorf(`ent: validator failed for field "PermissionGroup.icon": %w`, err)}
		}
	}
	if _, ok := pgc.mutation.Sort(); !ok {
		return &ValidationError{Name: "sort", err: errors.New(`ent: missing required field "PermissionGroup.sort"`)}
	}
	if _, ok := pgc.mutation.Left(); !ok {
		return &ValidationError{Name: "left", err: errors.New(`ent: missing required field "PermissionGroup.left"`)}
	}
	if _, ok := pgc.mutation.Right(); !ok {
		return &ValidationError{Name: "right", err: errors.New(`ent: missing required field "PermissionGroup.right"`)}
	}
	if _, ok := pgc.mutation.State(); !ok {
		return &ValidationError{Name: "state", err: errors.New(`ent: missing required field "PermissionGroup.state"`)}
	}
	if v, ok := pgc.mutation.State(); ok {
...
func (pgc *PermissionGroupCreate) createSpec() (*PermissionGroup, *sqlgraph.CreateSpec) {
	...
	if value, ok := pgc.mutation.Icon(); ok {
		_spec.SetField(permissiongroup.FieldIcon, field.TypeString, value)
		_node.Icon = value
	}
