...
func (prru *PermissionRelatedRouterUpdate) SetUpdateTime(t time.Time) *PermissionRelatedRouterUpdate {
	prru.mutation.SetUpdateTime(t)
	return prru
}
...
func (prru *PermissionRelatedRouterUpdate) Save(ctx context.Context) (int, error) {
	prru.defaults()
	return withHooks[int, PermissionRelatedRouterMutation](ctx, prru.sqlSave, prru.mutation, prru.hooks)
}
...
func (prru *PermissionRelatedRouterUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(permissionrelatedrouter.Table, permissionrelatedrouter.Columns, sqlgraph.NewFieldSpec(permissionrelatedrouter.FieldID, field.TypeUUID))
...
// SetUpdateTime sets the "update_time" field.
func (prruo *PermissionRelatedRouterUpdateOne) SetUpdateTime(t time.Time) *PermissionRelatedRouterUpdateOne {
	prruo.mutation.SetUpdateTime(t)
	return prruo
}
...
func (prruo *PermissionRelatedRouterUpdateOne) Save(ctx context.Context) (*PermissionRelatedRouter, error) {
	prruo.defaults()
	return withHooks[*PermissionRelatedRouter, PermissionRelatedRouterMutation](ctx, prruo.sqlSave, prruo.mutation, prruo.hooks)
}
...
func (prruo *PermissionRelatedRouterUpdateOne) sqlSave(ctx context.Context) (_node *PermissionRelatedRouter, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "PermissionRelatedRouter.id" for update`)}
	}
