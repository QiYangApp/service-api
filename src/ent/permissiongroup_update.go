...
func (pgu *PermissionGroupUpdate) SetIcon(s string) *PermissionGroupUpdate {
	pgu.mutation.SetIcon(s)
	return pgu
}

// SetNillableIcon sets the "icon" field if the given value is not nil.
func (pgu *PermissionGroupUpdate) SetNillableIcon(s *string) *PermissionGroupUpdate {
	if s != nil {
		pgu.SetIcon(*s)
	}
	return pgu
...
func (pgu *PermissionGroupUpdate) Save(ctx context.Context) (int, error) {
	pgu.defaults()
	return withHooks[int, PermissionGroupMutation](ctx, pgu.sqlSave, pgu.mutation, pgu.hooks)
}
...
func (pgu *PermissionGroupUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pgu.mutation.Icon(); ok {
...
// SetIcon sets the "icon" field.
func (pguo *PermissionGroupUpdateOne) SetIcon(s string) *PermissionGroupUpdateOne {
	pguo.mutation.SetIcon(s)
	return pguo
}

// SetNillableIcon sets the "icon" field if the given value is not nil.
func (pguo *PermissionGroupUpdateOne) SetNillableIcon(s *string) *PermissionGroupUpdateOne {
	if s != nil {
		pguo.SetIcon(*s)
	}
	return pguo
...
func (pguo *PermissionGroupUpdateOne) Save(ctx context.Context) (*PermissionGroup, error) {
	pguo.defaults()
	return withHooks[*PermissionGroup, PermissionGroupMutation](ctx, pguo.sqlSave, pguo.mutation, pguo.hooks)
}
...
func (pguo *PermissionGroupUpdateOne) sqlSave(ctx context.Context) (_node *PermissionGroup, err error) {
	...
	if value, ok := pguo.mutation.Icon(); ok {
		_spec.SetField(permissiongroup.FieldIcon, field.TypeString, value)
	}
