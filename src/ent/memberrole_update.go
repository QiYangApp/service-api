...
func (mru *MemberRoleUpdate) Save(ctx context.Context) (int, error) {
	mru.defaults()
	return withHooks[int, MemberRoleMutation](ctx, mru.sqlSave, mru.mutation, mru.hooks)
}
...
func (mruo *MemberRoleUpdateOne) Save(ctx context.Context) (*MemberRole, error) {
	mruo.defaults()
	return withHooks[*MemberRole, MemberRoleMutation](ctx, mruo.sqlSave, mruo.mutation, mruo.hooks)
}
