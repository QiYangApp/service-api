...
func (mrrpd *MemberRoleRelatedPermissionDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, MemberRoleRelatedPermissionMutation](ctx, mrrpd.sqlExec, mrrpd.mutation, mrrpd.hooks)
}
...
func (mrrpd *MemberRoleRelatedPermissionDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(memberrolerelatedpermission.Table, sqlgraph.NewFieldSpec(memberrolerelatedpermission.FieldID, field.TypeUUID))
