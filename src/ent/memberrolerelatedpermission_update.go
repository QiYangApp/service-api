...
func (mrrpu *MemberRoleRelatedPermissionUpdate) SetUpdateTime(t time.Time) *MemberRoleRelatedPermissionUpdate {
	mrrpu.mutation.SetUpdateTime(t)
	return mrrpu
}
...
func (mrrpu *MemberRoleRelatedPermissionUpdate) Save(ctx context.Context) (int, error) {
	mrrpu.defaults()
	return withHooks[int, MemberRoleRelatedPermissionMutation](ctx, mrrpu.sqlSave, mrrpu.mutation, mrrpu.hooks)
}
...
func (mrrpu *MemberRoleRelatedPermissionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(memberrolerelatedpermission.Table, memberrolerelatedpermission.Columns, sqlgraph.NewFieldSpec(memberrolerelatedpermission.FieldID, field.TypeUUID))
...
// SetUpdateTime sets the "update_time" field.
func (mrrpuo *MemberRoleRelatedPermissionUpdateOne) SetUpdateTime(t time.Time) *MemberRoleRelatedPermissionUpdateOne {
	mrrpuo.mutation.SetUpdateTime(t)
	return mrrpuo
}
...
func (mrrpuo *MemberRoleRelatedPermissionUpdateOne) Save(ctx context.Context) (*MemberRoleRelatedPermission, error) {
	mrrpuo.defaults()
	return withHooks[*MemberRoleRelatedPermission, MemberRoleRelatedPermissionMutation](ctx, mrrpuo.sqlSave, mrrpuo.mutation, mrrpuo.hooks)
}
...
func (mrrpuo *MemberRoleRelatedPermissionUpdateOne) sqlSave(ctx context.Context) (_node *MemberRoleRelatedPermission, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "MemberRoleRelatedPermission.id" for update`)}
	}
