...
func (*MemberRoleRelatedPermission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case memberrolerelatedpermission.FieldID, memberrolerelatedpermission.FieldRoleID, memberrolerelatedpermission.FieldPermissionGroupID:
			values[i] = new(uuid.UUID)
		default:
			return nil, fmt.Errorf("unexpected column %q for type MemberRoleRelatedPermission", columns[i])
		}
	}
	return values, nil
}
...
func (mrrp *MemberRoleRelatedPermission) Unwrap() *MemberRoleRelatedPermission {
	...
	if !ok {
		panic("ent: MemberRoleRelatedPermission is not a transactional entity")
	}
