...
func (malc *MemberAuthorizeLogCreate) SetIpv4(s string) *MemberAuthorizeLogCreate {
	malc.mutation.SetIpv4(s)
	return malc
}

// SetIpv6 sets the "ipv6" field.
func (malc *MemberAuthorizeLogCreate) SetIpv6(s string) *MemberAuthorizeLogCreate {
	malc.mutation.SetIpv6(s)
	return malc
}
...
func (malc *MemberAuthorizeLogCreate) Save(ctx context.Context) (*MemberAuthorizeLog, error) {
	malc.defaults()
	return withHooks[*MemberAuthorizeLog, MemberAuthorizeLogMutation](ctx, malc.sqlSave, malc.mutation, malc.hooks)
}
...
func (malc *MemberAuthorizeLogCreate) check() error {
	...
	if _, ok := malc.mutation.Ipv4(); !ok {
		return &ValidationError{Name: "ipv4", err: errors.New(`ent: missing required field "MemberAuthorizeLog.ipv4"`)}
	}
	if v, ok := malc.mutation.Ipv4(); ok {
	...
	if _, ok := malc.mutation.Ipv6(); !ok {
		return &ValidationError{Name: "ipv6", err: errors.New(`ent: missing required field "MemberAuthorizeLog.ipv6"`)}
	}
	if v, ok := malc.mutation.Ipv6(); ok {
...
func (malc *MemberAuthorizeLogCreate) createSpec() (*MemberAuthorizeLog, *sqlgraph.CreateSpec) {
	...
	if value, ok := malc.mutation.Ipv4(); ok {
		_spec.SetField(memberauthorizelog.FieldIpv4, field.TypeString, value)
		_node.Ipv4 = value
	}
	if value, ok := malc.mutation.Ipv6(); ok {
