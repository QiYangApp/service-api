...
func (prrd *PermissionRelatedRouterDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, PermissionRelatedRouterMutation](ctx, prrd.sqlExec, prrd.mutation, prrd.hooks)
}
...
func (prrd *PermissionRelatedRouterDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(permissionrelatedrouter.Table, sqlgraph.NewFieldSpec(permissionrelatedrouter.FieldID, field.TypeUUID))
