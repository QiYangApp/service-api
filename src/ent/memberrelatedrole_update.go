...
func (mrru *MemberRelatedRoleUpdate) Save(ctx context.Context) (int, error) {
	mrru.defaults()
	return withHooks[int, MemberRelatedRoleMutation](ctx, mrru.sqlSave, mrru.mutation, mrru.hooks)
}
...
func (mrruo *MemberRelatedRoleUpdateOne) Save(ctx context.Context) (*MemberRelatedRole, error) {
	mrruo.defaults()
	return withHooks[*MemberRelatedRole, MemberRelatedRoleMutation](ctx, mrruo.sqlSave, mrruo.mutation, mrruo.hooks)
}
